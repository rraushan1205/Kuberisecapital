...
export function BrandMark({ compact = false }: { compact?: boolean }) {
  return (
    <Link href="/login" className="group inline-flex items-center gap-2.5 rounded-md outline-none focus-visible:ring-2 focus-visible:ring-[var(--focus)]" aria-label="Kuberise Capital secure access">
      ...
      {!compact && <span className="text-[15px] font-semibold tracking-[-0.03em] text-[var(--ink)]">Kuberise Capital</span>}
    </Link>
  );
}
